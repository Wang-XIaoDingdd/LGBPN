...
# python train.py -s DBSNl_weightnorm_p4p7_br2restormer_mod -c APBSN_SIDD/BSN_SIDD --wandb True -g '1,0,2,3' #
# python train.py -s APBSN_DND_p4p7_br2restormer_mod -c APBSN_DND/BSN_DND --wandb True -g '1,0' #
